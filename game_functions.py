...
# Description: Checks for ship movements from user, other events,
...
def fire_bullet(ai_settings, screen, ship, bullets):
	"""Fire a bullet it limit not reached yet."""
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
	...
	# Draw the play button if the fame is inactive.
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
	"""Update position to bullets and get rid of old bullets."""
